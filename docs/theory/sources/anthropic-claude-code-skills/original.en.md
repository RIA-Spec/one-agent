...
If you're new to skills, I'd recommend reading our docs or watching our newest course on Skilljar on Agent Skills — this post will assume you already have some familiarity with skills.
...
To understand how a skill is doing, we use a PreToolUse hook that lets us log skill usage within the company (example code available from Anthropic). This means we can find skills that are popular or are undertriggering compared to our expectations.
