...
async def main():
    ...
    await tool('playwright_browser_navigate', {'url': 'https://www.google.com'})
    ...
    snapshot_result = await tool('playwright_browser_snapshot', {})
    ...
    await tool('playwright_browser_type', {
        'ref': search_box_ref,
        'text': 'red hairstyle',
        'submit': True
    })
    ...
    await tool('playwright_browser_wait_for', {'time': 3})
    
    # 6. Get search results page snapshot
    print('6. Getting search results snapshot...')
    result_snapshot = await tool('playwright_browser_snapshot', {})
    ...
    await tool('playwright_browser_take_screenshot', {
        'type': 'png',
